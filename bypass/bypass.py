...
def slow_aes(value):
    with open("bypass/aes.txt", "r") as fp:
...
def main():
    code = bypass()
    cookies = "_ym_uid=1658477733375770370; _ym_d=1691243404; xf_notice_dismiss=-1; xf_tfa_trust=ZpDB9yLkZN5eNO19k91QYbDvQ6CAPOJj; xf_user=1050943%2CI1M3oVVWAzlyK32D_ivUw-jaw8y7wvJExKFxgvZ4; _ga_25SQLLK3B1=GS1.1.1691586289.4.0.1691586289.60.0.0; _gid=GA1.2.114239003.1693833049; xf_csrf=5EbRHXpYwYjr5E32; xf_session=H0Ezbihhaz2ijra-mHlTQpgcVO-9KmTC; _ga_KQRCJL2214=GS1.1.1693895397.49.0.1693895397.0.0.0; _ga=GA1.2.1379025495.1669037304; _gat_gtag_UA_175660820_1=1"  # Из браузера копируем авторизованные куки без куки react lab arz
    cookies += f"; {code[0]}"
